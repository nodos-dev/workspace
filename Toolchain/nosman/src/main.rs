...
fn main() {
    let mut cmd = Command::new("nosman")
        ...
        .subcommand(Command::new("publish")
            ...
            .arg(Arg::new("author_name")
                .help("Name of the publisher. If not provided, the name of the current git user will be used.")
                .long("author-name")
                .required(false)
            )
            .arg(Arg::new("author_email")
                .help("Email of the publisher. If not provided, the email of the current git user will be used.")
                .long("author-email")
                .required(false)
            )
            .arg(Arg::new("dry_run")
