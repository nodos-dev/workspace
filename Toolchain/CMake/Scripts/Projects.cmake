...
function(nos_get_module name version out_target_name)
	...
	if(NOSMAN_EXECUTABLE)
		...
		if(nosman_result EQUAL 0)
			...
			string(JSON mos_module_include_folder ERROR_VARIABLE err GET "${nosman_output}" "public_include_folder")
			if (err EQUAL 0)
				message(STATUS "Found ${name} ${version} include folder: ${mos_module_include_folder}")
...
function(_nos_add_module NAME INCLUDE_FOLDERS MANIFEST_FILE_EXT ADDITIONAL_FILE_TYPES)
	project(${NAME})
	...
	set(INCLUDED_IN_PROJECT ${source_files} ${header_files} ${config_files} ${NODE_DEFINITION_FILES} ${type_schema_files} ${shader_files} ${additional_files} ${MODULE_MANIFEST_FILE})
